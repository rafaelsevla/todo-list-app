...
it('createReducer(initialState, {}) should be return a function', () => {
  expect(createReducer([], {})).to.be.a('function')
})
...
it('should reducer return latest state if action is unknown', () => {
  const before = 3
...
it('reducer should return initialState when latest state if undefined', () => {
...
it('iniitalState should not be undefined', () => {
  try {
